      ...
      <Route exact path="/Addmovie" render={()=>(
          <div className="search-movie">
            ...
            <ol className="movies-grid">
            {
              ...
              <SearchResult key={result.id} result={result} movies={this.state.movies} onChangepart={this.updatemovie} />
            ...
            <div className="list-movies-content">
              <div>
                ...
                <div className="moviepart">
                  ...
                  <div className="moviepart-movies">
                    <ol className="movies-grid">
                      <moviecomp movies={this.state.movies} part="watch" onChangepart={this.updatemovie}/>
                    </ol>
                  </div>
                </div>
              </div>
